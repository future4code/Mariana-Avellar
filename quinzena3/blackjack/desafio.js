...
// Código que sorteia duas cartas para o usuário e soma sua pontuação
   ...
   // Sorteia novas cartas quando o usuário começa com dois ases (A)

   while (somaUsuario === (22)) {
      carta = comprarCarta();
      cartaUsuario.push(carta);
      pontosUsuario.push(carta.valor);
      carta = comprarCarta();
   ...
   // Sorteia novas cartas quando o computador começa com dois ases (A)
   ...
   console.log("Computador - cartas:", cartaComputador[0], "- pontuação", pontosComputador[0])
  
   confirm(
      "Suas cartas são: " + carta.texto + " A carta revelada do computador é: " + carta.texto +
      "\n"+
